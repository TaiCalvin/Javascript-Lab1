...
if (myName1.length === myName2.length & myName1.length === myName3.length) {
  console.log ("All three names, " + myName1 + " " + myName2 + " " + myName3 + " are the same length.")
} 
  ...
  console.log (myName1 + " & " + myName2 + " are tied for the longest names.")
}
else if (myName1.length === myName3.length) {
  console.log (myName1 + " & " + myName3 + " are tied for the longest names")
}
  ...
  console.log (myName3 + " & " + myName2 + " are tied the longest names.")
}